...
public:
    MessageBuffer()            // ctor
    {
        ...
        m_hMutex = CreateMutex( nullptr,    // no security attributes
        ...
        m_hEvent = CreateEvent( nullptr,     // no security attributes
...
int main()
{
    ...
    hthConsumer = (HANDLE)_beginthreadex( nullptr,
                                          0,
    ...
    hthProducer = (HANDLE)_beginthreadex( nullptr,
                                          0,
